<%-- 
    Document   : Twin
    Created on : Jul 13, 2024, 5:39:10 PM
    Author     : ASUS
--%>
        ...
        <form action="bookingForm.jsp" method="post" >
            ...
            <div class="container" style="margin-bottom: 128px;margin-top: 151px;">
                ...
                <div class="row">
                    <div class="col-md-7">
                        <div class="row">
                            <div class="col-md-12"><img class="img-thumbnail img-fluid center-block" src="assets/img/menu/TWIN.png" width="400" height="300"></div>
                        </div>
                    </div>

                    <div class="col-md-5">
                        <h1>Superior Twin Room</h1>
                        <p style="margin-bottom: 20px;">Welcome to our Superior Twin Room, 
                        ...
                        <p><b>PAX: 4 ADULTS <br> ROOM NUMBER: T01-1, T02-1, T01-2, T02-2</b>
                        <h2 class="text-center text-success">RM 155.00 per room</h2>

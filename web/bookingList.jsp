    ...
    <body class="text-body">
        ...
        <form action='bookingList.jsp' method='POST'>
            ...
            <sql:query var="result" dataSource="${myDatasource}">
                ...
                JOIN APP.ROOM ON APP.BOOKING.ROOMID = APP.ROOM.ROOMID
                where USERID =${userid}
            </sql:query>
            <div class="pb-5">
                <div class="container">
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" class="border-0 bg-light">
                                                <div class="py-2 text-uppercase">ROOM NUM</div>
                                            </th>
                                            <th scope="col" class="border-0 bg-light">
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach var="row" items="${result.rows}">
                                            <tr>
                                                ...
                                                <td class="border-0 align-middle"><strong><c:out value="${row.ROOM_NUM}"/></strong></td> 

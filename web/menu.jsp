        ...
        <div class="container">
            ...
            <div class="row projects">
                <div class="col-sm-6 item">
                        <div class="row">
                            <div class="col-md-12 col-lg-5"><a href="King.jsp"><img class="img-fluid" src="assets/img/menu/KING.jpeg"></a></div>
                            <div class="col">
                ...
                <div class="col-sm-6 item">
                        <div class="row">
                            <div class="col-md-12 col-lg-5"><a href="Twin.jsp"><img class="img-fluid" src="assets/img/menu/TWIN.png"></a></div>
                            <div class="col">
                    ...
                    <div class="col-sm-6 item">
                        <div class="row">
                            <div class="col-md-12 col-lg-5"><a href="Family.jsp"><img class="img-fluid" src="assets/img/menu/FAMILY.png"></a></div>
                            <div class="col">
                    ...
                    <div class="col-sm-6 item">
                        <div class="row">
                            <div class="col-md-12 col-lg-5"><a href="BigFamily.jsp"><img class="img-fluid" src="assets/img/menu/BIGFAMILY.jpg"></a></div>
                            <div class="col">

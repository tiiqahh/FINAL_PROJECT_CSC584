        ...
        <form action="bookingForm.jsp" method="post" >
            ...
            <div class="container" style="margin-bottom: 128px;margin-top: 151px;">
                ...
                <div class="row">
                    <div class="col-md-7">
                        <div class="row">
                            <div class="col-md-12"><img class="img-thumbnail img-fluid center-block" src="assets/img/menu/FAMILY.png" width="400" height="300"></div>
                        </div>
                    </div>

                    <div class="col-md-5">
                        <h1>Family Room-1 King Bed</h1>
                        <p style="margin-bottom: 20px;">Welcome to our Family Room-1 King Bed, 
                        ...
                        <p><b>PAX: 6 ADULTS <br> ROOM NUMBER: FR01-1, FR02-1, FR01-2, FR02-2</b>
                        <h2 class="text-center text-success">RM 175.00 per room</h2>
